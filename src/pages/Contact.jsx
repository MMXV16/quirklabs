...
const Contact = () => {
  ...
  return (
    <>
            ...
            <div className="space-y-6">
              ...
              <div className="flex items-start">
                ...
                <div>
                  ...
                  <p className="text-gray-600 dark:text-gray-300">
                    contact@quirklabs.com<br />
                    support@quirklabs.com
                  </p>
                </div>
              </div>
      ...
      {/* Map Section */}
      <Section dark={true}>
        <h2 className="text-3xl font-bold mb-8 font-playfair text-center">Find Us</h2>
        <div className="aspect-video bg-gray-800 rounded-lg overflow-hidden">
          <div className="w-full h-full flex items-center justify-center">
            <span className="text-2xl font-bold font-playfair">Map Placeholder</span>
          </div>
        </div>
      </Section>
    </>
