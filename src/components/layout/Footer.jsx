...
const Footer = () => {
  ...
  return (
    <motion.footer
      ...
      className="bg-black text-white dark:bg-gray-900 py-12"
    >
      <div className="container mx-auto px-4 md:px-6">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div className="col-span-1 md:col-span-1">
            <h3 className="text-2xl font-bold font-playfair mb-4">QuirkLabs</h3>
            <p className="text-gray-300 mb-4">
              Invent the Unusual. Build the Exceptional.
            </p>
          ...
          <div className="col-span-1">
            ...
            <ul className="space-y-2">
              ...
              <li><a href="/services" className="text-gray-300 hover:text-white transition-colors">AI Solutions</a></li>
          ...
          <div className="col-span-1">
            ...
            <address className="not-italic text-gray-300">
              ...
              <p className="mb-2">contact@quirklabs.com</p>
        ...
        <div className="border-t border-gray-700 mt-8 pt-8 text-center">
          <p className="text-gray-400">
            &copy; {currentYear} QuirkLabs. All rights reserved.
          </p>
        </div>
      </div>
    </motion.footer>
